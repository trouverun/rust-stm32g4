...
pub const DEFAULT_CALIBRATION_CURRENT_A: f32 = 1.0;
pub const DEFAULT_CALIBRATION_SWEEP_OMEGA: f32 = 1.0;
pub const DEFAULT_CALIBRATION_SPIN_OMEGA: f32 = 1.0;
pub const DEFAULT_RATED_CURRENT_LIMIT_A: f32 = 1.0;
pub const DEFAULT_MOMENTARY_CURRENT_LIMIT_A: f32 = 1.0;
pub const DEFAULT_ROTOR_SPEED_LIMIT_MECH_RPM: u16 = 1000;
pub const DEFAULT_ROTOR_OVERSPEED_LIMIT_MECH_RPM: u16 = 1000;
...
pub const DEFAULT_SENSORLESS_HIGH_SPEED_THRESHOLD: f32 = 30.0;
pub const DEFAULT_SENSORLESS_LOW_SPEED_PLL_FREQUENCY_HZ: f32 = 10.0;
pub const DEFAULT_SENSORLESS_HIGH_SPEED_PLL_FREQUENCY_HZ: f32 = 50.0;
